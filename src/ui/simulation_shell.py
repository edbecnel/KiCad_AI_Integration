"""Embeddable Simulation / SUBCKT gap-fill panel (wxPython)."""
...
class SimulationShell(wx.Panel if wx else object):  # type: ignore[misc]
    """List simulation model gaps and generate SUBCKT .lib files (embeddable panel)."""
