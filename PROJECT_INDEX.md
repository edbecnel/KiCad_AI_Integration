...
- [Handover notes](HANDOVER.md) (session handover index — authoritative sprint summary)
- [Manual validation checklist](docs/Developer_Handbook/Manual_Validation_Checklist.md) (Phase 1 E2E + Freerouting — human sign-off)
- [Platform backlog](docs/PLATFORM_BACKLOG.md) (deferred product/platform items)
...
- [ADP-014: Firmware-Aware Mixed-Domain Simulation](docs/Architecture/ADP-014-Firmware-Aware-Mixed-Domain-Simulation.md) (proposed — DCBM / Level 1 not implemented)
